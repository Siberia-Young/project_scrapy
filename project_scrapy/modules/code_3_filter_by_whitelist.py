...
def filter_by_whitelist(platform_name, keywords1, keywords2, keywords3, file_path):
    recent_json_path = f"data_files/{platform_name}/recent_info/recent_filter.json"
    whitelist_json_path = f"data_files/{platform_name}/whitelist_filter.json"
    confirm_json_path = f"data_files/{platform_name}/confirm_filter.json"
