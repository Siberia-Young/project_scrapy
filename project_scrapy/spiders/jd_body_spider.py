...
from project_scrapy.modules.tools.import_store_information import import_store_information
from project_scrapy.modules.tools.export_store_information import export_store_information
...
class JDBodySpider(scrapy.Spider):
    name = "jd_body"
    ...
    def parse(self, response):
        file_path = '../data/jd/merge/merge_2_3.xlsx'
        import_store_information('jd', file_path)
        # 打开需读取的excel表
        ...
        try:
                ...
                while not finish:
                    ...
                    if len(verifyCodeImg) != 0:
                        try:
                            ...
                            # 保存截图
                            element_screenshot.save('imgs/element_screenshot.png')
                            temp_image_path = 'imgs/element_screenshot.png'
            ...
            export_store_information('jd', file_path)

            item = Item()
            item['category'] = 'JD_process_2'
            item['end'] = True
            yield item